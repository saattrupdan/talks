...
let b:atp_MainFile = 'appis_talk.tex'
let g:atp_mapNn = 0
let b:atp_autex = 1
...
let b:atp_OutDir = '/home/leidem/gitsky/talks/APPIS20 [incomplete]'
let b:atp_OpenViewer = '1'
let b:atp_XpdfServer = 'appis_talk'
let b:atp_Viewer = 'okular'
let b:TreeOfFiles = {}
let b:ListOfFiles = ['bib.bib']
let b:TypeDict = {'bib.bib': 'bib'}
let b:LevelDict = {'bib.bib': 1}
